...
Die durchgeführte Evaluation umfasste insgesamt neun Experimente, die aus der Kombination von drei LLMs (GPT-5.2, GPT-5.3-Codex und Gemini 3.1 Pro) mit drei unterschiedlichen Prompt-Strategien (Basis-Prompt, strukturierter Prompt und Role Prompting) entstanden. Im Mittelpunkt steht die Analyse des Einflusses von Modellwahl und Prompt-Gestaltung auf die Qualität der generierten Softwaresysteme.
