\subsection{GPT-5.3-Codex mit Rollendefinition}
Im dritten Experiment wurde GPT-5.3-Codex mittels Role Prompting angewiesen, die Rolle eines erfahrenen Softwarearchitekten und Full-Stack-Entwicklers einzunehmen. Ziel war die Untersuchung, ob die explizite Rollendefinition die Qualität und Vollständigkeit der generierten Lösung weiter verbessert.

Die Evaluation des mit GPT-5.3-Codex  unter Verwendung eines strukturierten Prompts mit Rollendefinition generierten Systems in \ref{tab:GPT-5.3-Codex5.3 strukturiertes prompt und Rollendefinition} zeigte mehrere Einschränkungen bei der Umsetzung komplexerer Geschäftsprozesse.
...
\label{tab:GPT-5.3-Codex5.3 strukturiertes prompt und Rollendefinition}
...
Keine vollständigen Benutzerabläufe oder automatisierten Integrationstests teilweise vorhanden. \\
\midrule
...
Insbesondere konnte die Funktion zur Erstellung neuer Rechnungen nicht vollständig ausgeführt werden.
