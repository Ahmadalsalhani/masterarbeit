\subsection{GPT-5.2 mit strukturiertem Prompt}
Das zweite Experiment (\ref{tab:gptv2}) wurde unter Verwendung eines strukturierten und detailliert definierten Prompts durchgeführt.
Insgesamt erreichte GPT-5.2 mit dem strukturiertem Prompt sieben von 18 möglichen Bewertungspunkten.
...
Im dritten Experiment (\ref{tab:gptv3}) wurde GPT-5.2 mittels Role Prompting angewiesen, die Rolle eines erfahrenen Softwarearchitekten und Full-Stack-Entwicklers einzunehmen. Es sollte untersucht werden, ob die explizite Rollendefinition die Qualität und Vollständigkeit der generierten Lösung weiter verbessert wird.

Die \ref{tab:gptv3} zeigt die Ergebnisse der Evaluation.
...
Die Ergebnisse (\ref{tab:gptv2}) verdeutlichen somit,dass ein strukturierter Prompt die funktionale Vollständigkeit eines generierten
